// Contenido público del tenant heredado. Es el mismo que guarda businesses.public_config/contact
// (migración 20260924040000) y solo se usa como valor inicial mientras resuelve el dominio.
export const LEGACY_PUBLIC_CONFIG: Record<string, unknown> = {
  seo: {
    ...
    description:
      'Peluquería y barbería Adrián Millán en Huelva (Calle Artesanos 6, zona Santa Marta / La Orden). Especialistas en degradados fade, corte clásico y barba. Cita previa online.',
    ogTitle: 'Peluquería y Barbería Adrián Millán | Huelva',
    ogDescription:
      'Peluquería y barbería profesional en Huelva. Especialistas en corte masculino, degradados fade y cuidado de barba. Reserva tu cita online.',
...
export const LEGACY_CONTACT: Record<string, unknown> = {
  phone: '+34614922082',
